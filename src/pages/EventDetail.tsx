...
const allEvents: Record<string, {
  ...
  "3": {
    ...
    attendees: 56,
    type: "training",
    description: "Open training session for aspiring young footballers. Come showcase your talent and learn from our experienced coaching staff. All skill levels welcome. Bring your boots and water!",
    location: "EFC Training Ground, Pitch 3",
    duration: "3 hours",
    speakers: [
  ...
  "4": {
    ...
    attendees: 210,
    type: "social",
    description: "An exclusive meet and greet with EFC's star players! Get autographs, take photos, and hear stories from behind the scenes. Light refreshments will be served. Limited spots available!",
    location: "EFC Clubhouse, Main Hall",
    duration: "2 hours",
    speakers: [
  ...
  "5": {
    ...
    attendees: 189,
    type: "webinar",
    description: "Learn how data analytics is revolutionizing football. From xG models to player tracking, explore the tools and techniques used by professional clubs.",
