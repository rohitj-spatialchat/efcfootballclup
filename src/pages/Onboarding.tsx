    ...
    >
      ...
      <div className="relative z-10 w-full max-w-lg space-y-6 text-center">
        ...
        <div className="space-y-4 text-left px-2">
            ...
            <div className="relative">
              <select
                ...
                onChange={(e) => {
                  ...
                  setClub(newClub);
                  const matched = EFC_CLUBS.find((c) => c.name === newClub);
                  if (matched?.country) setCountry(matched.country);
                }}
          ...
          <div>
            <label className="text-sm font-bold text-gray-900 mb-1 block">Title</label>
            <div className="relative">
              <select
                value={position}
